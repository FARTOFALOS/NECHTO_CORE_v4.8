...
- **[Полная спецификация v4.8 (FULL)](SPEC_v4.8_FULL.md)** ← Полная техническая документация (части 0–11, модули M01–M30, реализация A–E)
- **[Метрики и Прокси](METRICS.md)** ← Описание метрик
- **[Границы контура](CONTOUR_BOUNDARY.md)** ← Операциональные границы
- **[PRRIP & GATE](PRRIP.md)** ← Финальная проверка
- **[API](API.md)** ← Публичный API
